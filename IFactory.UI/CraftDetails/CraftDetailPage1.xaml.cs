...
namespace IFactory.UI.CraftDetails
{
    ...
    /// </summary>
    public partial class CraftDetailPage1 : BasePage, IComponentConnector
    {
        public CraftDetailPage1()
        {
            InitializeComponent();
        ...
        {
            Detail1Response detailResponse = LocalApi.ExecuteDetail1(new Detail1Request()
            {

...
{
    /// <summary>
    /// ProductionLineEditDialog.xaml 的交互逻辑
    /// </summary>
    public partial class ProductionLineEditDialog : Window, IComponentConnector
    {
        public ProductionLineEditDialog()
        {
            InitializeComponent();
        }

        private ProductionLineProbablyModel model;
        public int ProductionLineProbablyDID { get; set; }
        ...
        private void btnOK_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                ProductionLineProbablySaveResponse probablySaveResponse = LocalApi.Execute(new ProductionLineProbablySaveRequest() { DID = this.model.DID, Name = this.model.Name, TargetYield = this.model.TargetYield });

...
using IFactory.Domain.Crafts.Mylar.Mappings;
...
{
    public class MylarDbContext : CraftDbContext
    {
        public override IQueryable<FacilityProductionDataInfo> FacilityProductionDataInfos
        {
            get
            {
                return this.Set<MylarFacilityProductionDataInfo>();
            }
        }
        ...
        public override IQueryable<FacilityRunArgInfo> FacilityRunArgInfos
        {
            get
            {
                return this.Set<MylarFacilityRunArgInfo>();
            }
        }

        static MylarDbContext()
        {
            Database.SetInitializer<MylarDbContext>(null);
        }

        public MylarDbContext(string nameOrConnection)
        ...
        {
            Type configType = typeof(MylarFacilityRunArgMap);

...
using IFactory.Domain.Crafts.FEF.Mappings;
...
{
    public class FEFDbContext : CraftDbContext
    {
        public override IQueryable<FacilityProductionDataInfo> FacilityProductionDataInfos
        {
            get
            {
                return this.Set<FEFFacilityProductionDataInfo>();
            }
        }
        ...
        public override IQueryable<FacilityRunArgInfo> FacilityRunArgInfos
        {
            get
            {
                return this.Set<FEFFacilityRunArgInfo>();
            }
        }

        static FEFDbContext()
        {
            Database.SetInitializer<FEFDbContext>(null);
        }

        public FEFDbContext(string nameOrConnection)
        ...
        {
            Type configType = typeof(FEFFacilityRunArgMap);

...
using IFactory.Domain.Crafts.Inspection1.Mappings;
...
{
    public class Inspection1DbContext : CraftDbContext
    {
        public override IQueryable<FacilityProductionDataInfo> FacilityProductionDataInfos
        {
            get
            {
                return this.Set<Inspection1FacilityProductionDataInfo>();
            }
        }
        ...
        public override IQueryable<FacilityRunArgInfo> FacilityRunArgInfos
        {
            get
            {
                return this.Set<Inspection1FacilityRunArgInfo>();
            }
        }

        static Inspection1DbContext()
        {
            Database.SetInitializer<Inspection1DbContext>(null);
        }

        public Inspection1DbContext(string nameOrConnection)
        ...
        {
            Type configType = typeof(Inspection1FacilityRunArgMap);
